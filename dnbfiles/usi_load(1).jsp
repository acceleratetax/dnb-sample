...
usi_32623 = new usi_load.Campaign({
	id: '1372631165110810713656',
	company_id: '2641',
	site_id: '32623',
	email_id: '0',
	config_id: '59983',
	...
	extra_javascript: function(){
        ...
        usi_commons.load_script(destination + "&ajax=1", usi_app.add_creditmonitor_to_cart_from_admin());
      };
		} catch(err) {
			if (typeof usi_commons !== "undefined") usi_commons.report_error(err);
			return false;
