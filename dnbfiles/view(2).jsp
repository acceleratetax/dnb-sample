...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '8326783138149264973593',
			site_id: 30427,
			original_site_id: 30427,
			config_id: 53723,
			company_id: 2641,
			key: 'desktop_company',
			link: 'https://cart.dnb.com/checkout?utm_source=creditsignal&utm_medium=in_product&utm_campaign=upsell_creditmonitor&utm_content=locked_cp',
			deep_link: '',
			domains: '',
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/2641/DunBradstreet-TT-7-2020-NI-dsktpNeeNEW.png",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
 ...
 usi_app.variant = "Desktop [Company Profile Bar]";
...
usi_js.click_cta = function(){
  //update status of lead for PC
  usi_commons.load_precapture("s1zoQ0DfqHP74uREHtdwv1J", "34583");
  ...
  setTimeout(function(){
    ...
    usi_js.link_clicked();
    usi_app.add_creditmonitor_to_cart_from_admin_proactive();
  },2000);
};
...
usi_js.display_vars.p1_html = [
  	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Click Here"></button>',
